package com.example.homework4.jwt;

import com.example.homework4.dto.ApiResponseDto;
import com.example.homework4.security.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(token != null) {
            if(!jwtUtil.validateToken(token)) {
                ApiResponseDto responseDto = new ApiResponseDto("토큰이 유효하지 않다 게로.", HttpStatus.BAD_REQUEST.value());
